...
fun String.provideLogo() = when (this) {
    "01n", "01d" -> R.drawable.ic_clear_sky_01d
    "02n", "02d" -> R.drawable.ic_few_clouds_02d
    "03n", "03d" -> R.drawable.ic_scattered_clouds_03d
    "04n", "04d" -> R.drawable.ic_broken_clouds_04d
    "09n", "09d" -> R.drawable.ic_shower_rain_09d
    "10n", "10d" -> R.drawable.ic_rain_10d
    "11n", "11d" -> R.drawable.ic_thunderstorm_11d
    "13n", "13d" -> R.drawable.ic_snow_13d
    "50n", "50d" -> R.drawable.ic_mist_50d
    else -> R.drawable.ic_error
}
